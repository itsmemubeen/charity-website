...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">All Donations List</h4>
                ...
                <div id="example23_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4"><div class="dt-buttons">          
                    ...
                    <thead>
                        <tr>
                            ...
                            <th rowspan="1" colspan="1">Donation Created By</th>
                            <th rowspan="1" colspan="1">Donation Title</th>
                            <th rowspan="1" colspan="1">Donation Desc</th>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th rowspan="1" colspan="1">Donation Title</th>
                            <th rowspan="1" colspan="1">Donation Desc</th>
                            <th rowspan="1" colspan="1">Total : ${{\App\Models\Donation::sumdonation()}}</th>
                            <th rowspan="1" colspan="1">Created Date</th>
                            <th rowspan="1" colspan="1">Action</th>
                        </tr>
                    </tfoot>
                    ...
                    <tr role="row" class="odd">
                            ...
                            <td>{{ $data->members->f_name }}</td>
                            <td>{{ $data->d_title }}</td>
                            <td>{!! substr($data->d_desc, 0,20) !!}</td>
                            <td>${{ $data->d_amount }}</td>
                            <td>{{ $data->created_at }}</td>
                            {{-- <td>{{ date_format($data->created_at,"d/m/Y") }}</td> --}}
                            <td>
                                <button class="dt-button buttons-copy buttons-html5 btn btn-primary me-1" style="float: right">Edit</button>
                                <form method="POST" action="{{route('donation.destroy',[$data->id])}}">
                                    @csrf
                                    @method('delete')
