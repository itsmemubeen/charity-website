                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="d-flex no-block align-items-center">
                            ...
                            <div class="ms-auto">
                                <h2 class="counter text-primary">{{\App\Models\User::countUsers()}}</h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-md-12">
                        <div class="d-flex no-block align-items-center">
                            <div>
                                ...
                                <p class="text-muted">All Petition</p>
                            </div>
                            <div class="ms-auto">
                    ...
                    <div class="col-md-12">
                        <div class="d-flex no-block align-items-center">
                            <div>
                                ...
                                <p class="text-muted">All Goals</p>
                            </div>
                            <div class="ms-auto">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <div class="d-flex">
                    <div>
                        <h5 class="card-title">All New Petitions Signed</h5>
                    </div>
                </div>
            </div>
