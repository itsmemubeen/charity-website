...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">All Goals List <a href="{{ route('goal.create') }}"><button class="dt-button buttons-copy buttons-html5 btn btn-primary me-1" style="float: right">Add Goal</button></a></h4>
                ...
                <div id="example23_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4"><div class="dt-buttons">          
                    ...
                    <thead>
                        <tr>
                            ...
                            <th rowspan="1" colspan="1">Goal Name</th>
                            <th rowspan="1" colspan="1">Goal Slug</th>
                    ...
                    <tr role="row" class="odd">
                            ...
                            <td>{{ $data->goal_slug }}</td>
                            <td>{{ $data->created_at }}</td>
                            <td>
                                <a href="{{ route('goal.edit',[$data->id]) }}"><button class="dt-button buttons-copy buttons-html5 btn btn-primary me-1" style="float: right">Edit</button></a>
                                <form method="POST" action="{{route('goal.destroy',[$data->id])}}">
                                    @csrf
                                    @method('delete')
