...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">All Pages List <a href="{{ route('page.create') }}"><button class="dt-button buttons-copy buttons-html5 btn btn-primary me-1" style="float: right">Add Page</button></a></h4>
            ...
            <div class="table-responsive m-t-40">
                <div id="example23_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4"><div class="dt-buttons">          
                    ...
                    <tr role="row" class="odd">
                            ...
                            <td>
                                <a href="{{ route('page.edit',[$data->id]) }}"><button class="dt-button buttons-copy buttons-html5 btn btn-primary me-1" style="float: right">Edit</button></a>
